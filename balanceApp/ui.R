          ...
          sidebarLayout(
              ...
              mainPanel(
                tabsetPanel(
                  tabPanel(
                  "Instructions", 
                  HTML("<p>The Life Equilibrium Visualizer is a Shiny web app that graphically displays the way you allocate your efforts across time. The code used to create this can be found on GitHub <a href = 'https://github.coecis.cornell.edu/mdt29/balance'>here</a>. The Life Equilibrium Visualizer mirrors Figure 2 in the paper \"Work and Life In Dynamic Equilibrium.\"</p>"),
